...
2. Download [services](https://github.com/soma-space/files/tree/main/services/arcanine) and open config.ini, change IP to the IP noted above, change ServicePath to your extracted `services` folder
