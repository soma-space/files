...
public:
	...
	CWndAniTilePreview m_WndATPreview; // 타일 에니메이션 프리뷰
...
protected:
	...
	afx_msg void OnBLightSourceColorSet();
	afx_msg void OnPaint();
	afx_msg void OnBNewLightSourceData();
	afx_msg void OnBLoadLightSourceData();
	afx_msg void OnBSaveLightSourceData();
	afx_msg void OnChangeELightSourceNumber();
	afx_msg void OnRadioAreaEdit();
	afx_msg void OnDelTileset();
	afx_msg void OnBSaveTsSpl();
	afx_msg int OnCreate(LPCREATESTRUCT lpCreateStruct);
	afx_msg void OnBTileAniAdd();
	afx_msg void OnBTileAniDel();
	afx_msg void OnCheckTileAnimation();
	afx_msg void OnBTileAnimation();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
