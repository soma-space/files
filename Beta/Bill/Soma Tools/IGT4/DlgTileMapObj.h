...
public:
	...
	CMapObjTool m_ShadowObj;	// 그림자 객체...
	CMapObjTool m_HOutObj;		// 집밖 객체...
	CMapObjTool m_HInObj;		// 집안 객체...

	int m_vCurrentVersion;
	BOOL		m_bShowInnerHouse;	// 집안 보이기
public:
	CWndObjPreview* m_pWndObjPreview;
...
protected:
	...
	afx_msg void OnBSprFileNameSet2();
	afx_msg void OnBSprFileNameDelete2();
	afx_msg void OnBSprFileNameSet3();
	afx_msg void OnBSprFileNameSet4();
	afx_msg void OnBSprFileNameDelete3();
	afx_msg void OnBSprFileNameDelete4();
	afx_msg void OnCheckShowInnerhouse();
	afx_msg void OnCObjPreView();
