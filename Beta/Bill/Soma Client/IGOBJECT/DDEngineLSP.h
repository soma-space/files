...
class CDDEngineLSP : public CDDEngineNew  
{
public:
	void BltLSP(LPDIRECTDRAWSURFACE7 lpDDSDest, int x, int y, const _SPR_LSP* pSprLSP, int nRenderType = RENDER_NORMAL, int nAlpha = 16, COLORREF crColor = 0);
