...
void MouseSelectManager::SetStartPos(CPoint pos)
{
	...
	m_vCurPos[0].x = t_p.x - 32;	m_vCurPos[0].y = t_p.y;
	m_vCurPos[1].x = t_p.x;			m_vCurPos[1].y = t_p.y - 16;
	m_vCurPos[2].x = t_p.x + 32;	m_vCurPos[2].y = t_p.y;
	m_vCurPos[3].x = t_p.x;			m_vCurPos[3].y = t_p.y + 16;
